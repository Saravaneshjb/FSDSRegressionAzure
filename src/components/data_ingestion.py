import os
import sys #For system error and exception
...
##Intitalize data ingestion configuration 
@dataclass #THis is a constructor
class DataIngestionConfig:
    train_data_path:str=os.path.join('artefacts','train.csv')
    test_data_path:str=os.path.join('artefacts','test.csv')
    raw_data_path:str=os.path.join('artefacts','raw.csv')
